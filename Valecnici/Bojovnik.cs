...
namespace Valecnici
{
    public class Bojovnik : Postava
    {
        ...
        {
            Console.WriteLine(Jmeno + " zautocil mecem na" + druhaPostava.Jmeno + tretiPostava.Jmeno);
        ...
        {
            Console.WriteLine(Jmeno + " zautocil mecem na " + druhaPostava.Jmeno);
            druhaPostava.PocetZivotu = druhaPostava.PocetZivotu - SilaUtoku;
        }

        public Bojovnik(string jmeno, int SilaUtoku) : base(jmeno, SilaUtoku) //jmeno predame konstruktoru predka, coz je Postava. A ta uz kod na ulozeni jmena do property Jmeno ma 
        {
        }
    }
